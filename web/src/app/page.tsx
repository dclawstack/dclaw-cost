...
import {
  ...
  Landmark, Tag, Container, BarChart3, Zap, ShoppingCart, Leaf, Trash2,
  ArrowRight, Sparkles, ShieldCheck, TrendingDown, Github,
} from "lucide-react";

const FEATURES = [
  { icon: Bot,        title: "AI Cost Copilot",        desc: "Chat with an AI assistant that knows your live spend, alerts, and savings opportunities.", tag: "P0" },
  { icon: Cloud,      title: "Multi-Cloud Billing",    desc: "Unified view of AWS, GCP, Azure, and on-prem costs from a single dashboard.", tag: "P0" },
  { icon: Lightbulb,  title: "Resource Right-Sizing", desc: "AI analyzes 30 days of utilization and recommends optimal instance types.", tag: "P0" },
  { icon: PiggyBank,  title: "Budget Alerts",          desc: "Set budgets per service or team. Get alerted before you overspend, not after.", tag: "P0" },
  { icon: Landmark,   title: "Reserved Instance Planner", desc: "Model 6 commitment types with break-even analysis and annual savings forecasts.", tag: "P1" },
  { icon: Trash2,     title: "Waste Detection",        desc: "Scan for idle resources, orphaned volumes, unused IPs, old snapshots, and more.", tag: "P1" },
  { icon: Tag,        title: "Cost Allocation",        desc: "Tag-based showback and chargeback. Allocate 100% of spend to teams and projects.", tag: "P1" },
  { icon: Container,  title: "Container Cost Analysis", desc: "Per-pod and per-namespace cost breakdown for Kubernetes workloads.", tag: "P1" },
  { icon: BarChart3,  title: "FinOps Reports",         desc: "Executive dashboards with unit economics, MoM trends, and AI insights.", tag: "P2" },
  { icon: Zap,        title: "Spot Instance Strategy", desc: "Classify workloads and surface spot candidates with interruption risk scores.", tag: "P2" },
  { icon: ShoppingCart, title: "SaaS Spend Management", desc: "Track licenses, costs, renewals, and identify duplicate or unused tools.", tag: "P2" },
  { icon: Leaf,       title: "Carbon Cost",            desc: "Estimate CO₂ emissions per service and region. Get green-region suggestions.", tag: "P2" },
];

const STEPS = [
  { n: "01", title: "Connect", desc: "Link your AWS, GCP, Azure, or on-prem account in under a minute. Ingest billing data via API." },
  { n: "02", title: "Analyze", desc: "AI scans 30+ days of utilization, identifies waste, and forecasts spend across teams and services." },
  { n: "03", title: "Save",    desc: "Apply recommendations with one click. Track savings, set budgets, and chat with the copilot." },
];

const STATS = [
  { value: "30%", label: "Average cloud spend reduction" },
  { value: "5+",  label: "Cloud providers supported" },
  { value: "12",  label: "FinOps features out of the box" },
  { value: "60+", label: "Backend API endpoints" },
];
      ...
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 text-sm md:flex">
            ...
            <a href="https://github.com/dclawstack/dclaw-cost" target="_blank" rel="noreferrer" className="flex items-center gap-1 text-gray-600 hover:text-gray-900">
        ...
        <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-4 py-1.5 text-xs font-medium text-gray-600 shadow-sm">
              ...
              AI-powered FinOps · Built for engineering teams
            </div>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-600">
              Unified multi-cloud billing, AI-driven recommendations, real-time budget alerts,
              and per-team cost allocation — powered by an AI copilot that understands your live data.
            </p>
            ...
            <p className="mt-6 text-xs text-gray-500">
              No credit card required · OSS · Self-hostable
            </p>
          </div>
              ...
              <div className="grid grid-cols-12 gap-4 p-6">
                ...
                <div className="col-span-8 rounded-lg border border-gray-100 p-4">
                  ...
                  <div className="space-y-2">
                    {[{ s: "EC2", v: 100 }, { s: "RDS", v: 65 }, { s: "S3", v: 40 }, { s: "Lambda", v: 22 }].map((d) => (
                      <div key={d.s} className="flex items-center gap-3 text-xs">
                        <span className="w-12 text-gray-600">{d.s}</span>
                        <div className="flex-1 h-2 rounded-full bg-gray-100">
                          <div className="h-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-500" style={{ width: `${d.v}%` }} />
                        </div>
                      </div>
                    ))}
                  </div>
                </div>
                <div className="col-span-4 rounded-lg border border-gray-100 p-4">
                  <div className="flex items-center gap-2 mb-3">
                    <Bot className="h-4 w-4 text-blue-500" />
                    <div className="text-xs text-gray-500">AI Copilot</div>
                  </div>
                  <div className="text-xs leading-relaxed text-gray-600">
                    &ldquo;Your EC2 spend is up 18% MoM. 3 t3.xlarge instances are idle — consider downsizing to save $420/mo.&rdquo;
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              12 production-ready features that turn cloud spend from a mystery into a managed budget.
            </p>
          </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium backdrop-blur-sm">
                ...
                YC S25/W26 AI mandate
              </div>
              <h2 className="mt-6 text-4xl font-bold leading-tight tracking-tight sm:text-5xl">
                Your AI Cost Copilot,<br />trained on your data.
              </h2>
              <p className="mt-6 text-lg leading-relaxed text-blue-100">
                Ask anything about your cloud spend. The copilot reads your live billing data,
                budget status, and open recommendations — then suggests specific next steps.
                Powered by Kimi K2 via OpenRouter, with Ollama fallback.
              </p>
              <ul className="mt-8 space-y-3">
                {[
                  "Context-aware: knows current spend, top drivers, active alerts",
                  ...
                  <li key={f} className="flex items-start gap-3 text-sm text-blue-100">
                    <ShieldCheck className="h-5 w-5 flex-shrink-0 text-green-300" />
                    {f}
                  </li>
                ))}
              </ul>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="max-w-[80%] rounded-2xl rounded-tl-sm bg-white/10 px-4 py-3 text-sm leading-relaxed">
                    Your EC2 spend grew $4,820 (18%) MoM. The top contributors:
                    <br /><br />
                    1. <strong>3 new r5.4xlarge instances</strong> in us-east-1 ($1,890)<br />
                    2. <strong>Spot interruptions</strong> shifted traffic to on-demand ($1,640)<br />
                    3. <strong>NAT Gateway egress</strong> jumped 240% ($1,290)
                    <br /><br />
                    Suggested actions: convert the r5.4xlarge fleet to reserved (~40% savings),
                    review the spot fallback config, and audit the egress source.
                  </div>
                </div>
                <div className="ml-auto max-w-[80%] rounded-2xl rounded-tr-sm bg-blue-600 px-4 py-2.5 text-sm">
                  Generate the RI plan
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="border-t border-gray-100 bg-gray-50 py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-8 md:grid-cols-3">
            {[
              { icon: TrendingDown, title: "Stop spend leaks", desc: "Automatic alerts when budgets hit threshold or forecast to exceed. No more end-of-month surprises." },
              { icon: ShieldCheck,  title: "Production-ready",  desc: "55 backend tests, 60+ API endpoints, Postgres-backed, Helm + Docker deploy. Built like infra you can trust." },
              { icon: Leaf,         title: "Carbon-aware",      desc: "Estimate CO₂ per service and region. Get suggestions to migrate workloads to greener regions." },
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-6 text-lg text-gray-600">
            Connect your first cloud account in under a minute. See savings opportunities in real-time.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              href="/dashboard"
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-2 text-xs text-gray-400">v1.0 · OSS</span>
            </div>
            <div className="flex items-center gap-6 text-sm text-gray-600">
              ...
              <a href="https://github.com/dclawstack/dclaw-cost" target="_blank" rel="noreferrer" className="hover:text-gray-900">GitHub</a>
            </div>
            <div className="text-xs text-gray-400">© 2026 DClaw Stack · FinOps</div>
          </div>
        </div>
      </footer>
    </div>
