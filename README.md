...
>
> FinOps app in the DClaw Stack. Built with Next.js, FastAPI, PostgreSQL, and the DKube Design System.

[![Status](https://img.shields.io/badge/status-P4%20Planned-14B8A6)](https://github.com/dclawstack/dclaw-cost)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/cost)

---

## Overview

DClaw Cost is an AI-native finops application. It follows the standard DClaw architecture:
...
DClaw Cost uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-cost.git
cd dclaw-cost
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_cost"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-cost.git /opt/dclaw-cost
cd /opt/dclaw-cost
docker compose up -d
```

The app will be available at `https://cost.dclawstack.io`.
...
helm upgrade --install dclaw-cost . \
...
- [Docs](https://docs.dclawstack.io/apps/cost)
